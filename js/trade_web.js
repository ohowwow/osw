 ...
 function composeToHtml(fileData, description, condition, url1, url2) {
   htmlStr = '\<div class=\"separator\" style=\"clear: both; text-align: center;\"\> \
    \<figure class=\"v_h_center rounded_box\"\> \
      \<a class=\"rounded_box\" href=\"' + fileData[0] + '\"\>\<img data-original-height=\"1080\" data-original-width=\"810\" height=\"362\" src=\"' + fileData[0] + '\" width=\"272\" /\>\</a\> \
      \<figcaption\> \
        \<blockquote\> \
          \<h3 style=\"text-align: left;\"\>產品說明：\</h3\> \
            ...
            \<blockquote style=\"border: none; margin: 0px 0px 0px 40px; padding: 0px; text-align: left;\"\> \
              ' + condition + ' \
            \</blockquote\> \
          \<h3 style=\"text-align: left;\"\>哪裡買：\</h3\> \
            \<blockquote style=\"border: none; margin: 0px 0px 0px 40px; padding: 0px; text-align: left;\"\> \
            \<p\> \
              \<a href=\"' + url1 + '\" style=\"outline-width: 0px; user-select: auto;\" target=\"_blank\"\>\<b\>旋轉拍賣\</b\>\</a\> \
              \<a href=\"' + url2 + '\" style=\"outline-width: 0px; text-align: left; user-select: auto;\" target=\"_blank\"\>\<b\>賣貨便\</b\>\</a\> \
            \</p\> \
            \</blockquote\> \
        \</blockquote\> \
      \</figcaption\> \
   ...
   for (let i = 1; i < length; i++) {
     ...
     if (fileData[i] != "")
       thumbnailStr += '\<a class=\"rounded_box\" href=\"' + fileData[i] + '\"\>\<img data-original-height=\"1080\" data-original-width=\"810\" height=\"640\" src=\"' + fileData[i] + '\" width=\"100\" /\>\</a\>';
   }
